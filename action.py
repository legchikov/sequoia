import os
from cfg.config import PATH_ACTIONS
...
def get_action(action_name):
    try:
        with open(os.path.join(PATH_ACTIONS, action_name)) as file:
            header = []
            template = []
            ...
            return Action(header_str, template_str)
...
def fmake_action(action_name, file_name):
    header = ''
    message = []
